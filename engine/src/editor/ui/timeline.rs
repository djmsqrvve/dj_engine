...
use super::super::state::{COLOR_PRIMARY, COLOR_SECONDARY};
...
pub fn draw_timeline_view(ui: &mut egui::Ui, _world: &mut World) {
    ...
    for i in 0..20 {
        ...
        if x < ruler_rect.right() {
            painter.line_segment(
                [Pos2::new(x, ruler_rect.bottom()), Pos2::new(x, ruler_rect.bottom() - 10.0)],
    ...
    let tracks = vec![
        Track {
            ...
            clips: vec![(50.0, 100.0, "Move Input".into()), (300.0, 50.0, "Jump".into())],
        },
        Track {
            name: "⚙️ PHYSICS".into(),
            color: Color32::from_rgb(255, 100, 0),
            clips: vec![(55.0, 100.0, "Velocity".into()), (305.0, 150.0, "Gravity Calc".into())],
        },
        Track {
        ...
        Track {
            ...
            clips: vec![(310.0, 80.0, "Jump SFX".into()), (450.0, 100.0, "Sparkle".into())],
        },
    ];
    ...
    for (idx, track) in tracks.iter().enumerate() {
        ...
        painter.rect_stroke(
            ...
            2.0, Stroke::new(1.0, Color32::GRAY)
        );
        painter.text(Pos2::new(name_pos.x + 10.0, btn_y + 10.0), egui::Align2::CENTER_CENTER, "M", egui::FontId::monospace(10.0), Color32::GRAY);
        
        painter.rect_stroke(
            Rect::from_min_size(Pos2::new(name_pos.x + 25.0, btn_y), Vec2::new(20.0, 20.0)), 
            2.0, Stroke::new(1.0, Color32::GRAY)
        );
        painter.text(Pos2::new(name_pos.x + 35.0, btn_y + 10.0), egui::Align2::CENTER_CENTER, "S", egui::FontId::monospace(10.0), Color32::GRAY);
